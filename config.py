...
from classes.config import Secret, ApiKey, ApiUrl, ConfigOnlineModels, ConfigOllamaModels
...
CONFIG_OLLAMA_MODELS = ConfigOllamaModels(**JSON_CONFIGS["ollama_models"])